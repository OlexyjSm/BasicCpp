//-----------------------------------------------------------------------------------------------#
//Task 3. Write a function that receives a pointer on a static arrayand its size.                        |
//The function distributes positive, negativeand zero elements into separate dynamic ones arrays |
//-----------------------------------------------------------------------------------------------#
